...
class Monster(val x: Int, val y: Int, val speed: Int, val hp: Int, val bounty: Int, val location: Int) extends Entity {
...
class NormalMonster(x: Int, y: Int, location: Int) extends Monster(x,y,2,2,20,location) 

class FastMonster(x: Int, y: Int, location: Int) extends Monster(x,y,5,1,15,location)

class TankMonster(x: Int, y: Int, location: Int) extends Monster(x,y,1,10,30,location)