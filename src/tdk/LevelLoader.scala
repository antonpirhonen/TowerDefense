...
object LevelLoader {
  ...
  val wave2 = {
    for (i <- 0 until 50) yield new NormalMonster(-25, -25, NormalMonster.startHP, -10*i)
  }
  
  val wave3 = {
    for (i <- 0 until 20) yield new FastMonster(-25*i, -25*i, FastMonster.startHP, -25*i)
  }
  
  val wave4 = {
    for (i <- 0 until 100) yield new NormalMonster(-25, -25, NormalMonster.startHP, -10*i)
    for (i <- 0 until 10) yield new TankMonster(-25*i, -25*i, TankMonster.startHP, -10*i)
  }
